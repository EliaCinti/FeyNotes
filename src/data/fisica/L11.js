const LESSON = {
    ...
    sections: [
         ...
         ==================================================== */
      {
        ...
        subsections: [
          {
            ...
            <p>2. <strong>Molla compressa</strong>: $L \lt L_0$, la molla è più corta della lunghezza naturale ($\\Delta L \\lt 0$).</p>
            <p>3. <strong>Molla allungata (elongata)</strong>: $L \gt L_0$, la molla è più lunga della lunghezza naturale ($\\Delta L \\gt 0$).</p>`
          }
        ],
        extra_content: `<div class="diagram-placeholder" style="border: 1px dashed var(--border-light); border-radius: 8px; padding: 20px; margin: 20px 0; text-align: center; color: var(--text-muted); font-size: 0.85rem;">
          <p><strong>📊 Diagramma 1 — La molla nei tre stati</strong></p>
          <p><em>Tre configurazioni della molla ancorate a un muro a sinistra: (a) a riposo con lunghezza $L_0$, (b) compressa con spire ravvicinate, (c) allungata con spire distanziate. Linea tratteggiata verticale sulla posizione O.</em></p>
         ...
         ==================================================== */
      {
        ...
        subsections: [
          ...
          },
          {
            ...
            content: `<p><strong>Caso 1 — Molla allungata</strong> ($\\Delta L \\gt 0$, estremo spostato a destra):</p>
            ...
            <p>$$\\Delta L \\gt 0 \\Rightarrow F_e = -k\\Delta L \\lt 0 \\quad \\text{(forza verso sinistra)}$$</p>
            <p><strong>Caso 2 — Molla compressa</strong> ($\\Delta L \\lt 0$, estremo spostato a sinistra):</p>
            ...
            <p>$$\\Delta L \\lt 0 \\Rightarrow F_e = -k\\Delta L \\gt 0 \\quad \\text{(forza verso destra)}$$</p>
          ...
          },
          {
            ...
            <p>Molla A: $k_A = 200\\,\\text{N/m}$ (rigida) $\\Rightarrow F_A = 200 \\times 0.1 = 20\\,\\text{N}$</p>
            <p>Molla B: $k_B = 10\\,\\text{N/m}$ (morbida) $\\Rightarrow F_B = 10 \\times 0.1 = 1\\,\\text{N}$</p>
            <p>A parità di deformazione, la molla rigida esercita una forza <strong>20 volte superiore</strong>.</p>`
          }
        ],
        extra_content: `<div class="diagram-placeholder" style="border: 1px dashed var(--border-light); border-radius: 8px; padding: 20px; margin: 20px 0; text-align: center; color: var(--text-muted); font-size: 0.85rem;">
          <p><strong>📊 Diagramma 2 — Forza elastica come forza di richiamo</strong></p>
          <p><em>Molla ancorata al muro con massa m. Due situazioni: (a) molla allungata con $\\vec{F}_e$ verso sinistra e $\\vec{\\Delta L}$ verso destra, (b) molla compressa con frecce invertite. Le due forze sono sempre antiparallele.</em></p>
          <p style="margin-top: 8px; font-size: 0.75rem; color: var(--accent);">[ immagine da inserire ]</p>
        </div>
        <div class="diagram-placeholder" style="border: 1px dashed var(--border-light); border-radius: 8px; padding: 20px; margin: 20px 0; text-align: center; color: var(--text-muted); font-size: 0.85rem;">
          <p><strong>📊 Diagramma 3 — Grafico $F_e$ vs $x$</strong></p>
          <p><em>Grafico cartesiano: asse x = deformazione, asse y = forza elastica. Retta per l'origine con pendenza negativa $-k$. Due rette con pendenza diversa ($-k_1$ e $-k_2$) per confrontare molla rigida e morbida.</em></p>
          <p style="margin-top: 8px; font-size: 0.75rem; color: var(--accent);">[ immagine da inserire ]</p>
        </div>`,
        formulas: [
         ...
         ==================================================== */
      {
        ...
        extra_content: `<div class="diagram-placeholder" style="border: 1px dashed var(--border-light); border-radius: 8px; padding: 20px; margin: 20px 0; text-align: center; color: var(--text-muted); font-size: 0.85rem;">
          <p><strong>📊 Diagramma 4 — Sistema massa-molla orizzontale</strong></p>
          <p><em>Muro a sinistra, molla con spire, massa m (rettangolo) su piano orizzontale senza attrito. Asse x con origine in x=0 (posizione di equilibrio). Forza elastica orizzontale sulla massa, forza peso e reazione normale verticali (che si bilanciano).</em></p>
          <p style="margin-top: 8px; font-size: 0.75rem; color: var(--accent);">[ immagine da inserire ]</p>
        </div>`
      },
      /* ====================================================
        ...
        subsections: [
          {
            ...
            <p>$$\\omega^2 = \\frac{k}{m} \\Rightarrow \\omega = \\sqrt{\\frac{k}{m}}$$</p>
          ...
          },
          {
            ...
            <p>Se $x \\gt 0$ (massa a destra dell'equilibrio): $\\ddot{x} \\lt 0$ (accelerazione verso sinistra).</p>
            <p>Se $x \\lt 0$ (massa a sinistra): $\\ddot{x} \\gt 0$ (accelerazione verso destra).</p>
        ...
        subsections: [
          {
            ...
            content: `<p>Immaginiamo di spostare la massa dalla posizione di equilibrio ($x = 0$) fino a una posizione $x = A \\gt 0$, e poi di lasciarla andare. Cosa succede?</p>
            <p><strong>Fase 1</strong>: La molla è allungata: $F_e \\lt 0$, la forza richiama la massa verso sinistra.</p>
            ...
            <p><strong>Fase 3</strong>: La molla ora è compressa: $F_e \\gt 0$, la forza rallenta la massa e poi la rispinge verso destra.</p>
            ...
            <div class="diagram-placeholder" style="border: 1px dashed var(--border-light); border-radius: 8px; padding: 20px; margin: 20px 0; text-align: center; color: var(--text-muted); font-size: 0.85rem;">
              <p><strong>📊 Diagramma 5 — Le fasi dell'oscillazione</strong></p>
              <p><em>Quattro fotogrammi: (a) massa in x=+A, v=0, forza verso sinistra. (b) massa in x=0, velocità massima, forza nulla. (c) massa in x=-A, v=0, forza verso destra. (d) massa in x=0, velocità massima. Sotto: linea con -A, 0, +A e frecce del moto avanti-indietro.</em></p>
              <p style="margin-top: 8px; font-size: 0.75rem; color: var(--accent);">[ immagine da inserire ]</p>
            </div>`
          },
          {
          ...
          },
          {
            ...
            <p><strong>Effetto della massa $m$</strong> (al numeratore sotto radice): la massa rappresenta l'<strong>inerzia</strong>. Una massa maggiore si oppone di più alle variazioni di velocità imposte dalla molla, e quindi impiega più tempo a completare un'oscillazione: $m \\uparrow \\Rightarrow T \\uparrow$ (oscillazione più lenta).</p>
            <p><strong>Effetto della costante elastica $k$</strong> (al denominatore sotto radice): $k$ misura la <strong>rigidezza</strong> della molla. Una molla più rigida esercita una forza di richiamo più intensa a parità di spostamento, abbreviando il periodo: $k \\uparrow \\Rightarrow T \\downarrow$ (oscillazione più rapida).</p>
         ...
         ==================================================== */
      {
        ...
        <p>$$\\text{Molla deformata} \\overset{\\text{Hooke}}{\\longrightarrow} \\vec{F}_e = -k\\vec{\\Delta L} \\overset{\\text{II Legge}}{\\longrightarrow} m\\ddot{x} = -kx \\overset{\\omega^2 = k/m}{\\longrightarrow} \\ddot{x} + \\omega^2 x = 0$$
</p>`,
        table_compare: {
        ...
        extra_content: `<div class="diagram-placeholder" style="border: 1px dashed var(--border-light); border-radius: 8px; padding: 20px; margin: 20px 0; text-align: center; color: var(--text-muted); font-size: 0.85rem;">
          <p><strong>📊 Diagramma 6 — Grafico x(t) sinusoidale</strong></p>
          <p><em>Grafico tempo (asse x) vs posizione (asse y). Curva coseno che oscilla tra +A e -A. Indicare il periodo T come distanza tra due massimi consecutivi. Indicare l'ampiezza A dal centro al picco.</em></p>
          <p style="margin-top: 8px; font-size: 0.75rem; color: var(--accent);">[ immagine da inserire ]</p>
        </div>
        <p><strong>Anticipazione:</strong> nella prossima lezione troveremo la soluzione dell'equazione differenziale: $x(t) = A\\cos(\\omega t + \\varphi)$, dove $A$ è l'ampiezza e $\\varphi$ è la fase iniziale. Studieremo inoltre l'energia nel moto armonico: energia cinetica, energia potenziale elastica e la loro conservazione.</p>`
      }
    ],
    ...
    oral_cards: [
      ...
      },
      {
        ...
        back: "$T = 2\\pi\\sqrt{m/k}$. La massa $m$ è al numeratore: $m \\uparrow \\Rightarrow T \\uparrow$ (oscillazione più lenta, maggiore inerzia). La costante $k$ è al denominatore: $k \\uparrow \\Rightarrow T \\downarrow$ (oscillazione più rapida, molla più rigida)."
      },
      {
        type: "tranello",
