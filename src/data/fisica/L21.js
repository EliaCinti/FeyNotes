const LESSON = {
    id: "L21", date: "Lezione 21 — 20 Apr 2026",
...
<p>$$\\frac{d\\vec{u}}{dt}\\bigg|_{S} = \\frac{d\\vec{u}}{dt}\\bigg|_{S'} + \\vec{\\omega} \\times \\vec{u}$$</p>
...
<p>$$\\frac{d\\vec{u}}{dt}\\bigg|_{S} = \\dot{u}_{x'} \\hat{e}_{x'} + \\dot{u}_{y'} \\hat{e}_{y'} + \\dot{u}_{z'} \\hat{e}_{z'} + u_{x'} \\frac{d\\hat{e}_{x'}}{dt}\\bigg|_{S} + u_{y'} \\frac{d\\hat{e}_{y'}}{dt}\\bigg|_{S} + u_{z'} \\frac{d\\hat{e}_{z'}}{dt}\\bigg|_{S}$$</p>
...
<p>$$\\frac{d\\hat{e}_{i'}}{dt}\\bigg|_{S} = \\vec{\\omega} \\times \\hat{e}_{i'}$$</p>
<p>Sostituendo:</p>
...
<p>$$\\frac{d\\hat{e}_{x'}}{dt}\\bigg|_{S} = \\vec{\\omega} \\times \\hat{e}_{x'}$$</p>
...
<p>$$\\frac{d\\vec{r}}{dt} = \\frac{d(\\vec{OO'})}{dt} + \\frac{d\\vec{r}\\,'}{dt}\\bigg|_{S}$$</p>
...
<p>$$\\frac{d\\vec{r}\\,'}{dt}\\bigg|_{S} = \\frac{d\\vec{r}\\,'}{dt}\\bigg|_{S'} + \\vec{\\omega} \\times \\vec{r}\\,' = \\vec{v}\\,' + \\vec{\\omega} \\times \\vec{r}\\,'$$</p>
...
<p>$$\\vec{a} = \\frac{d\\vec{v}}{dt} = \\frac{d\\vec{v}_{O'}}{dt} + \\frac{d\\vec{v}\\,'}{dt}\\bigg|_{S} + \\frac{d}{dt}(\\vec{\\omega} \\times \\vec{r}\\,')\\bigg|_{S}$$</p>
...
<p>$$\\frac{d\\vec{v}\\,'}{dt}\\bigg|_{S} = \\frac{d\\vec{v}\\,'}{dt}\\bigg|_{S'} + \\vec{\\omega} \\times \\vec{v}\\,' = \\vec{a}\\,' + \\vec{\\omega} \\times \\vec{v}\\,'$$</p>

<p><strong>Terzo termine:</strong> Sviluppiamo con la regola di Leibniz:</p>
<p>$$\\frac{d}{dt}(\\vec{\\omega} \\times \\vec{r}\\,')\\bigg|_{S} = \\frac{d\\vec{\\omega}}{dt} \\times \\vec{r}\\,' + \\vec{\\omega} \\times \\frac{d\\vec{r}\\,'}{dt}\\bigg|_{S}$$</p>
<p>Per il secondo fattore, applichiamo nuovamente Poisson a $\\vec{r}\\,'$:</p>
<p>$$\\frac{d\\vec{r}\\,'}{dt}\\bigg|_{S} = \\vec{v}\\,' + \\vec{\\omega} \\times \\vec{r}\\,'$$</p>
<p>Sostituendo:</p>
<p>$$\\frac{d}{dt}(\\vec{\\omega} \\times \\vec{r}\\,')\\bigg|_{S} = \\frac{d\\vec{\\omega}}{dt} \\times \\vec{r}\\,' + \\vec{\\omega} \\times \\vec{v}\\,' + \\vec{\\omega} \\times (\\vec{\\omega} \\times \\vec{r}\\,')$$</p>
...
<p>$$\\vec{a} = \\underbrace{\\vec{a}\\,'}_{\\text{acc. relativa}} + \\underbrace{\\vec{a}_{O'} + \\frac{d\\vec{\\omega}}{dt} \\times \\vec{r}\\,' + \\vec{\\omega} \\times (\\vec{\\omega} \\times \\vec{r}\\,')}_{\\text{acc. di trascinamento}} + \\underbrace{2\\,\\vec{\\omega} \\times \\vec{v}\\,'}_{\\text{acc. di Coriolis}}$$</p>`
        ...
        formulas: [
          ...
          { label: "Formula di Poisson", latex: "\\frac{d\\vec{u}}{dt}\\bigg|_{S} = \\frac{d\\vec{u}}{dt}\\bigg|_{S'} + \\vec{\\omega} \\times \\vec{u}" },
