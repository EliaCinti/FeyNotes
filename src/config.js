...
const COURSES = {
  fisica: {
    ...
    lessons: [
      ...
      { id: 'L51', num: 'Lezione 36', date: '03 Giu 2026', title: 'Trasformazioni Termodinamiche e Ciclo di Carnot', abstract: 'Riepilogo delle trasformazioni notevoli per gas ideali (adiabatica, isoterma, isocora, isobara) con confronto grafico, definizione di sorgente termodinamica, costruzione del ciclo di Carnot e derivazione del suo rendimento. Enunciato del Teorema di Carnot e schema della dimostrazione per assurdo.', category: 'termodinamica' },
      { id: 'L52', num: 'Lezione 37', date: '03 Giu 2026', title: 'Trasformazioni Termodinamiche e Ciclo di Carnot', abstract: 'Richiami sulle trasformazioni notevoli dei gas ideali (adiabatica, isoterma, isocora, isobara), definizione di sorgente termodinamica e studio completo del ciclo di Carnot con derivazione del rendimento.', category: 'termodinamica' },
    ],
  },
