...
const COURSES = {
  fisica: {
    ...
    lessons: [
      ...
      { id: 'L51', num: 'Lezione 36', date: '03 Giu 2026', title: 'Trasformazioni notevoli, cicli termodinamici e macchine termiche', abstract: 'Riepilogo dei gas ideali e del significato fisico del calore specifico. Analisi sistematica delle trasformazioni notevoli (adiabatica, isoterma, isocora, isobara). Cicli termodinamici, macchine termiche e frigorifere. Il ciclo di Carnot e il calcolo del suo rendimento.', category: 'termodinamica' },
      { id: 'L52', num: 'Lezione 37', date: '04 Giu 2026', title: 'Rendimento del Ciclo di Carnot e Secondo Principio della Termodinamica', abstract: 'Calcolo del rendimento del ciclo di Carnot, enunciati di Kelvin-Planck e Clausius del secondo principio, teorema di Carnot e introduzione all\'entropia come funzione di stato.', category: 'termodinamica' },
      { id: 'L53', num: 'Lezione 38', date: '08 Giu 2026', title: 'Teorema di Carnot e Teorema di Clausius: Verso l\'Entropia', abstract: 'Dalle conseguenze del teorema di Carnot alla disuguaglianza di Clausius, fino alla definizione rigorosa dell\'entropia come funzione di stato e al principio dell\'aumento dell\'entropia per sistemi isolati.', category: 'termodinamica' },
      { id: 'L54', num: 'Lezione 39', date: '10 Giu 2026', title: 'Energia inutilizzata, diagrammi T-S e calcolo di variazioni di entropia', abstract: 'Completiamo il discorso sull\'entropia introducendo l\'energia inutilizzata legata all\'irreversibilità, il diagramma termodinamico T-S come alternativa al piano di Clapeyron, e tre esempi concreti di calcolo della variazione di entropia dell\'universo termodinamico.', category: 'termodinamica' },
      { id: 'L55', num: 'Lezione 40', date: '11 Giu 2026', title: 'Variazione di Entropia per Gas Ideali ed Esercizi', abstract: 'Derivazione della formula generale per la variazione di entropia di un gas ideale, casi particolari per trasformazioni isoterma, isocora, isobara e adiabatica, e risoluzione di esercizi su entropia, macchine termiche e cicli termodinamici.', category: 'termodinamica' },
    ],
  },
  ...
  geometria: {
    ...
    lessons: [
      ...
      { id: 'L50', num: 'Lezione 36', date: '28 Mag 2026', title: 'Proprietà delle Proiezioni Ortogonali, Matrici Ortogonali e Operatori Aggiunti', abstract: 'Dimostrazione della simmetria della proiezione ortogonale, caratterizzazione completa delle matrici ortogonali con le sei proprietà equivalenti, descrizione esplicita di O(2) come rotazioni e riflessioni, e introduzione dell\'operatore aggiunto (trasposto) con la definizione di operatore autoaggiunto.', category: 'forme-quadratiche' },
    ],
  },
  controlli: {
    id: 'controlli',
  ...
  precorso: {
    ...
    lessons: [
      ...
      { id: 'L03', num: 'Lezione 3', date: '16 Set 2026', title: 'Geometria Cartesiana: la Retta, le Coniche, la Circonferenza e la Parabola', abstract: 'Dal piano cartesiano alla retta (forma esplicita e implicita, pendenza, fasci, parallelismo, perpendicolarità, distanza punto-retta), fino alle coniche: cono matematico, circonferenza e parabola, con applicazioni fisiche (riempimento di una vasca, traiettoria di un proiettile).', category: 'precorso' },
    ],
  },
};
