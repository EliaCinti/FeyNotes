...
const COURSES = {
  ...
  geometria: {
    ...
    lessons: [
      ...
      { id: 'L10', num: 'Lezione 10', date: '24 Mar 2026', title: 'Operazioni tra Matrici, Invertibilità e Trasposizione', abstract: 'Prodotto riga per colonna, algebra delle matrici quadrate, matrici invertibili con formula per il caso 2×2, e matrice trasposta con tutte le proprietà.', category: 'spazi-vettoriali' },
    ],
  },
  controlli: {
    id: 'controlli',
