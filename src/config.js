...
const COURSES = {
  fisica: {
    ...
    lessons: [
      ...
      { id: 'L36', num: 'Lezione 28', date: '13 Mag 2026', title: 'Il Corpo Rigido: Definizioni e Proprietà', abstract: 'Introduzione al corpo rigido come sistema di punti materiali con vincolo di rigidità. Proprietà fondamentali: lavoro nullo delle forze interne, calcolo del centro di massa per corpi continui, e classificazione dei moti (traslazione, rotazione, roto-traslazione).', category: 'dinamica' },
      { id: 'L37', num: 'Lezione 29', date: '13 Mag 2026', title: 'Il Corpo Rigido: Definizioni e Proprietà', abstract: 'Definizione formale di corpo rigido e vincolo di rigidità. Dimostrazione del lavoro nullo delle forze interne. Calcolo del centro di massa per corpi continui con densità volumica, superficiale e lineare. Esempi: sbarra omogenea, semicirconferenza, sbarra non omogenea. Cinematica del corpo rigido: pura traslazione, pura rotazione e moto roto-traslatorio.', category: 'dinamica' },
    ],
  },
