...
const COURSES = {
  ...
  geometria: {
    ...
    lessons: [
      ...
      { id: 'L45', num: 'Lezione 34', date: '25 Mag 2026', title: 'Proiezione ortogonale e procedimento di Gram-Schmidt', abstract: 'Dalla proiezione di un vettore su una retta alla proiezione su un sottospazio qualsiasi: costruiamo la proiezione ortogonale, il coefficiente di Fourier, il procedimento di Gram-Schmidt per ottenere basi ortonormali, e infine definiamo il complemento ortogonale dimostrando la decomposizione V = U ⊕ U⊥.', category: 'forme-quadratiche' },
    ],
  },
  controlli: {
    id: 'controlli',
