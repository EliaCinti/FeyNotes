...
const COURSES = {
  fisica: {
    ...
    lessons: [
      ...
      { id: 'L51', num: 'Lezione 36', date: '03 Giu 2026', title: 'Trasformazioni Termodinamiche e Ciclo di Carnot', abstract: 'Richiami sulle trasformazioni notevoli dei gas ideali (adiabatica, isoterma, isocora, isobara), definizione di sorgente termodinamica e studio completo del ciclo di Carnot con derivazione del rendimento.', category: 'termodinamica' },
      { id: 'L52', num: 'Lezione 37', date: '03 Giu 2026', title: 'Trasformazioni notevoli, cicli termodinamici e macchine termiche', abstract: 'Riepilogo dei gas ideali e del significato fisico del calore specifico. Analisi sistematica delle trasformazioni notevoli (adiabatica, isoterma, isocora, isobara). Cicli termodinamici, macchine termiche e frigorifere. Il ciclo di Carnot e il calcolo del suo rendimento.', category: 'termodinamica' },
    ],
  },
