...
const COURSES = {
  fisica: {
    ...
    lessons: [
      ...
      { id: 'L17', num: 'Lezione 17', date: '15 Apr 2026', title: 'Momento Angolare e Dinamica delle Rotazioni', abstract: 'Costruzione del formalismo per la dinamica rotazionale: momento di un vettore, momento angolare, teorema del momento angolare (seconda equazione cardinale), teorema del momento dell\'impulso e lavoro nelle rotazioni. Analogie complete tra dinamica traslazionale e rotazionale.', category: 'dinamica' },
    ],
  },
