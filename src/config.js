...
const COURSES = {
  ...
  geometria: {
    ...
    lessons: [
      ...
      { id: 'L18', num: 'Lezione 18', date: '16 Apr 2026', title: 'Sistemi Lineari Rettangolari e Rappresentazioni di Sottospazi', abstract: 'Come usare Cramer anche su sistemi non quadrati: riduzione tramite minore fondamentale, variabili libere come parametri. Rappresentazioni cartesiane e parametriche di sottospazi vettoriali e algoritmi per passare dall\'una all\'altra.', category: 'sistemi-lineari' },
    ],
  },
  controlli: {
    id: 'controlli',
