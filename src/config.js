...
const COURSES = {
  ...
  geometria: {
    ...
    lessons: [
      ...
      { id: 'L17', num: 'Lezione 17', date: '14 Apr 2026', title: 'Momento Angolare e Fenomeni Rotatori', abstract: 'Costruzione del formalismo della dinamica rotazionale: dal momento di un vettore al momento angolare, passando per il teorema del momento angolare (seconda equazione cardinale), il teorema del momento dell\'impulso e il lavoro nelle rotazioni. Analogia completa tra dinamica traslazionale e rotazionale.', category: 'sistemi-lineari' },
    ],
  },
  controlli: {
    id: 'controlli',
